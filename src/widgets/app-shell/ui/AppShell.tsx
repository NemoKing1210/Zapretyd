  ...
  return (
    <Box sx={{ display: 'flex', minHeight: '100vh' }}>
      <AppBar
        ...
        color="transparent"
        elevation={0}
        sx={{ borderBottom: '1px solid rgba(80,90,110,.14)', backdropFilter: 'blur(12px)' }}
      >
        <Toolbar>
          <Typography variant="h6" fontWeight={800} letterSpacing="-.04em">
            Zapretyd
          </Typography>
      ...
      <Drawer
        ...
        sx={{
          width: 240,
          flexShrink: 0,
          '& .MuiDrawer-paper': { width: 240, boxSizing: 'border-box', border: 0, pt: 8 },
        }}
      >
        <List>
          {navigation.map((item) => (
      ...
      <Box
        component="main"
        sx={{ flex: 1, p: { xs: 3, md: 5 }, pt: { xs: 12, md: 13 }, maxWidth: 1440 }}
      >
        {children}
      </Box>
    </Box>
