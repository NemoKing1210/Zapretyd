...
export const ru: Record<TranslationKey, string> = {
  ...
  'shell.latestVersionHint': 'Последняя доступная версия zapret-discord-youtube на данный момент',
  ...
  'overview.strategyActivated': 'Включена {{when}}',
  'overview.runningFor': 'Работает {{duration}}',
  'overview.pickStrategyHint': 'Выберите стратегию, чтобы создать службу.',
  'format.duration.daysHours': '{{days}} д {{hours}} ч',
  'format.duration.hoursMinutes': '{{hours}} ч {{minutes}} мин',
  'format.duration.minutesSeconds': '{{minutes}} мин {{seconds}} с',
  'format.duration.seconds': '{{seconds}} с',
  ...
  'versions.reinstallConfirmBody': 'Текущие файлы будут удалены, и релиз скачается заново.',
  ...
  'settings.startMinimizedHint': 'При автозапуске скрывать окно в системный трей.',
