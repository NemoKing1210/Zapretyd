export const en = {
  ...
  'overview.strategyActivated': 'Activated {{when}}',
  'overview.runningFor': 'Running for {{duration}}',
  'overview.pickStrategyHint': 'Pick a strategy to create the service.',
  'format.duration.daysHours': '{{days}}d {{hours}}h',
  'format.duration.hoursMinutes': '{{hours}}h {{minutes}}m',
  'format.duration.minutesSeconds': '{{minutes}}m {{seconds}}s',
